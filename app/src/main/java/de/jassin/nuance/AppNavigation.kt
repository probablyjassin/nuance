...
import de.jassin.nuance.screens.ArtistsScreen
import de.jassin.nuance.screens.HomeScreen
import de.jassin.nuance.screens.LoginScreen
import de.jassin.nuance.screens.PlaylistsScreen
import de.jassin.nuance.screens.SettingsScreen
import de.jassin.nuance.screens.SongsScreen
import de.jassin.nuance.screens.SplashScreen
import de.jassin.nuance.ui.features.PlayerScaffold
...
fun AppNavigation(userPrefs: UserPreferences) {
    ...
    val playlistCacheDatabase =
        remember {
            PlaylistCacheDatabase(
                context.applicationContext,
            )
        }
    val coverArtCache =
